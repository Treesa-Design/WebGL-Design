        ...
        >
          <div style={{ maxWidth: '1024px', margin: '0 auto', textAlign: 'center' }}>
            ...
            >
              ...
              >
                Immerse yourself in a world where digital artistry meets interactive technology. Experience stunning
                WebGL creations that push the boundaries of web-based visualization.
              </p>
            </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 clamp(16px, 4vw, 24px)' }}>
          ...
          >
            ...
            >
              ...
              >
                <svg
                  style={{ width: '32px', height: '32px', color: '#ff0080' }}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              ...
              >
                <svg
                  style={{ width: '32px', height: '32px', color: '#40e0d0' }}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              ...
              >
                <svg
                  style={{ width: '32px', height: '32px', color: '#ff8c00' }}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
